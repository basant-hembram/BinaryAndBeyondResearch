...
export default function PrivacyPolicy() {
    const privacyPolicyData = data.privacyPolicy as any;

    return (
        <div className="bg-none">
            <ScrollAnimations />
            <PageHero
                title={privacyPolicyData.pageHero.title}
                subtitle={privacyPolicyData.pageHero.subtitle}
            />
            ...
            <section className="">
                <div className="container max-md:px-4 mx-auto py-16 lg:py-20">
                    ...
                    <div className="space-y-6">
                        {privacyPolicyData.sections.map((section: any, index: number) => (
                            <div
                                key={section.id}
                    ...
                    <div className="relative mt-12 rounded-xl bg-[#0e0b1a] px-8 py-7 overflow-hidden" data-gsap="fade-up">
                        ...
                        <div className="relative z-[5] flex flex-col md:flex-row md:items-center gap-4 justify-between overflow-hidden">
                            ...
                            <a
                                href="mailto:info@binaryandbeyondresearch.com"
