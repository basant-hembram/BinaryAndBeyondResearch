...
const Banner = ({ title, subtitle, breadcrumbs, backgroundImage }: BannerProps) => {
  return (
    <section 
    ...
    >
      ...
      <div className="container max-md:px-4 mx-auto relative z-10">
        <h1 
          className="text-white text-[16px] lg:text-[32px] xl:text-[40px] font-bold mb-2"
          dangerouslySetInnerHTML={{ __html: title }}
        />
        {subtitle && (
          <p className="text-white/80 text-[13px] lg:text-[16px] mb-4">{subtitle}</p>
        )}
