...
const SupportDistributorsSection = () => {
  ...
  return (
    <section className="relative py-[45px] lg:py-[55px] xl:py-[100px] bg-cover">
      <div className="absolute inset-0 bg-none/80" style={{ backgroundImage: `url(${supportDistributors.backgroundImage})`, backgroundRepeat: 'no-repeat', backgroundPositionX: 'right' }}></div>
